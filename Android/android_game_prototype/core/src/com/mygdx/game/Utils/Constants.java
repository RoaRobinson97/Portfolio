...
public class Constants {
    ...
    public static final Vector2 PLAYER_FLYING_LINEAR_IMPULSE_Y = new Vector2(0, 8f);
    ...
    public static final float CEILING_X =50;
    ...
    public static final float SAFE_ZONE_X =45;
